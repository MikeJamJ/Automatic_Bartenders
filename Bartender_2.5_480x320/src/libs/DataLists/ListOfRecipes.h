...
const Recipe hurricane_[] = {
  Recipe(Rum, 74),
  Recipe(OrangeJuice, 88),
  Recipe(PassionJuice, 88),
  Recipe(Grenadine, 30)
};

const Recipe wRussian_[] = {
  Recipe(Vodka, 40),
  Recipe(Kahlua, 20),
  Recipe(Milk, 40)
};

const Recipe easterChampagne_[] = {
  Recipe(OrangeJuice, 60),
  Recipe(PineappleJuice, 60),
  Recipe(Prosecco, 40)
};
/*
const Recipe test_[] = {
  Recipe(OrangeJuice, 20),
  Recipe(PineappleJuice, 20)
};
*/
#endif